...
def test_gornash_equivalent_keeps_surface_syllable() -> None:
    connection = _conn()
...
def test_analyze_word_gornash_matches_syllable_root() -> None:
    connection = _conn()
    ...
    analysis = analyze_word(connection, "gornash_kagsha", "gar")
...
def test_gornash_two_char_lapag_root_composes_ordered_syllables() -> None:
    connection = _conn()
